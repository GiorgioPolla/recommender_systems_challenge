...
class HybridRecommender(object):
    ...
    def fit_slim(self, epochs=300, topk=100):
        if self.slim_cyt:
            self.W_slim = self.slim.fit(epochs=epochs)
    ...
    def recommend(self, user_id, alfa=6, beta=3, gamma=1.6, at=10, num_slim=0.17, exclude_seen=True):
        ...
        if self.CF_CB:
            ...
            scores_CB_CF = scores_item_cf#beta * scores_content_based + alfa * scores_item_cf + gamma * scores_user_cf
