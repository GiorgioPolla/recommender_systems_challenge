...
class SLIM_BPR_Cython(SimilarityMatrixRecommender, Recommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=35, logFile=None,
            batch_size = 1000, lambda_i = 1.0, lambda_j = 0.0, learning_rate=0.001, topK = 400,
            sgd_mode='adagrad', gamma=0.995, beta_1=0.9, beta_2=0.999,
            stop_on_validation = False, lower_validatons_allowed = 5, validation_metric = "MAP",
            evaluator_object = None, validation_every_n = 3):
        ...
        return self.get_S_incremental_and_set_W()
